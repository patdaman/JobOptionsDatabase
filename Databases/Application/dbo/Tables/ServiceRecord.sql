CREATE TABLE [dbo].[ServiceRecord] (
    ...
    CONSTRAINT [FK_ServiceRecord_Applicant] FOREIGN KEY ([ApplicantId]) REFERENCES [dbo].[Applicant] ([id]),
    CONSTRAINT [FK_ServiceRecord_Application] FOREIGN KEY ([ApplicationId]) REFERENCES [dbo].[Application] ([id])
);
